<x-html title="Plano">
    <x-dashboard>
        <main class="py-4 px-6 text-[#111828] w-full">
            <h1 class="text-3xl font-bold">Criar Plano</h1>
                ...
                <form action="{{route('plans.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-3 gap-4 bg-gray-50 py-4">
                        ...
                        <div class="flex flex-col space-y-1 max-w-96">
                            ...
                            <input class="text-base text-[#111828] font-normal py-2 px-3 border border-gray-300 rounded-md shadow-md" type="text" id="price" name="price">
                        </div>
                        <div class="flex flex-col space-y-1 max-w-96">
                            <label for="description">Descrição</label>
                            <input class="text-base text-[#111828] font-normal py-2 px-3 border border-gray-300 rounded-md shadow-md" type="text" id="description" name="description">
                        </div>
